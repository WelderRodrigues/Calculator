...
//Gambiarra com os preços
global.swisscalc.lib.operatorCache.tabOperator = new global.swisscalc.lib.operator(
  ...
  function (sy) {
    ...
    var price = op1 * op2 * 30;
    return price;
  }
);

global.swisscalc.lib.operatorCache.lisoOperator = new global.swisscalc.lib.operator(
  global.swisscalc.lib.operator.ARITY_BINARY,
  global.swisscalc.lib.operator.ASSOCIATIVITY_LEFT,
  2,
  2,
